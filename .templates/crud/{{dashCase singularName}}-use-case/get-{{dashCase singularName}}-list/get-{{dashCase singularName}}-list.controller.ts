...
import { I{{pascalCase singularName}}Service } from "src/infra/database/{{dashCase singularName}}/i.{{dashCase singularName}}.service";
import { {{pascalCase singularName}}PagedModel } from "src/infra/database/{{dashCase singularName}}/{{dashCase singularName}}-paged-model";
